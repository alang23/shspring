...
<form name="form1" method="post" action="<?=base_url()?>index.php/home/brand/update" enctype="multipart/form-data"/>
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
      ...
      <td colspan="2">
   <!-- <?=$fcf?>-->
    <textarea name="newsContent" style="width:100%;height:400px;visibility:hidden;"><?=$info['b_story']?></textarea>
    </td>
    </tr>
    <tr>
