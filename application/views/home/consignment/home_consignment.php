...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
      ...
      <td valign="middle"><?=$v['price']?></td>
       <td valign="middle"><img src="<?=base_url()?>uploads/productthumb/<?=$v['img']?>" width="60px" hieght="60px"/></td>
      ...
      <td>
		  ...
		  <a href="<?=base_url()?>index.php/home/consignment/update?id=<?=$v['id']?>">编辑</a> | 
		  <a href="javascript:void(0);" onclick="flush('删除后不能恢复，确定删除吗?','<?=base_url()?>index.php/home/consignment/del?id=<?=$v['id']?>')">删除</a> 
