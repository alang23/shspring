  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <a href="<?=base_url()?>index.php/home/discovery/add">
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td valign="middle"><img src="<?=base_url()?>uploads/discovery/<?=$v['img']?>" width="60px" height="60px"/></td>
        <td valign="middle"><?=$v['title']?></td>
        <td valign="middle"><?=$keys[$v['d_key']]?></td>
        <td valign="middle"><?=$v['rank']?></td> 
        <td>
                    
      <a href="<?=base_url()?>index.php/home/discovery/update?id=<?=$v['id']?>">编辑</a> | 
      <a href="javascript:void(0);" onclick="flush('删除后不能恢复，确定删除吗?','<?=base_url()?>index.php/home/discovery/del?id=<?=$v['id']?>')">删除</a> 
