...
<form name="form1" method="post" action="<?=base_url()?>index.php/home/taken/add" enctype="multipart/form-data"/>
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
       ...
       <td colspan="2">
         <input type="text"  class="form-control" name="title" placeholder="标题"> <span class="label label-danger">必填</span>
       </td>
  </tr>
      <tr>
       ...
       ?>
         <input type="radio" name="uid" value="<?=$v['id']?>" /><?=$v['phone']?>
         <?php
          }
         ?>
       </td>
  ...
  <td class="tableleft">简介</td>       
       <td colspan="2">
         <textarea name="intro" style="width:100%;height:600px;"></textarea>
       </td>
  </tr>
    <tr>
  <td class="tableleft">顺序</td>       
       <td colspan="2">
         <input type="text"  class="form-control" name="rank"  placeholder="标题"/>
       </td>
  </tr>
    <tr>
