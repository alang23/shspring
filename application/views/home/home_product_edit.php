...
<form name="form1" method="post" action="<?=base_url()?>index.php/home/product/update" enctype="multipart/form-data"/>
<div role="tabpanel">
                ...
                <div role="tabpanel" class="tab-pane active" id="home">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                           ...
                           <td colspan="2">
                             <input type="text" class="form-control" name="p_name" placeholder="产品名称" value="<?=$info['p_name']?>"> <span class="label label-danger">必填</span>
                           </td>
                      </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <tr>
                           ...
                           <td colspan="2">
                             <input type="radio" name="types" id="inlineCheckbox1" value="1" <?php if($info['types'] == 1){ ?> checked <?php } ?>> 普通产品
                             <input type="radio" name="types" id="inlineCheckbox1" value="2" <?php if($info['types'] == 2){ ?> checked <?php } ?>> 二手
                             <input type="radio" name="types" id="inlineCheckbox1" value="3" <?php if($info['types'] == 3){ ?> checked <?php } ?>> 周边
                             <input type="radio" name="types" id="inlineCheckbox1" value="4" <?php if($info['types'] == 4){ ?> checked <?php } ?>> 寄售
                           </td>
                      </tr>
                    </table>
                </div>
                ...
                <div role="tabpanel" class="tab-pane" id="messages">
                  ...
                  <ul id="piclist">
                    <?php
                      foreach($pic as $k => $v){
                    ?>
                    <li id="img_<?=$v['id']?>"><img src="<?=base_url()?>uploads/product/<?=$v['filename']?>" width="100px" height="100px"/><input type="hidden" name="pic[]" value="<?=$v['filename']?>" /><br/><a href="javascript:void(0);" onclick="delpic('img_<?=$v['id']?>');">删除</a></li>
                    <?php
                      }
                    ?>
                  </ul>
