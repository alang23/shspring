...
<form name="form1" method="post" action="<?=base_url()?>index.php/home/school/listsadd" enctype="multipart/form-data"/>
<table class="table table-bordered table-hover definewidth m10">
       ...
       <td colspan="2">
         <select name="sid">
          ...
          <?php
            foreach($list as $k => $v){
          ?>
            <option value="<?=$v['id']?>" <?php if($sid == $v['id']){ ?> selected <?php } ?>><?=$v['title']?></option>
            <?php
              }
            ?>
         </select>
    ...
    <tr>
      ...
      <tr>
       ...
       <td colspan="2">
         <textarea name="intro" style="width:60%;height:300px;"></textarea>
  </tr>
<tr>
