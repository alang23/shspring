...
<body>
<form name="form1" method="post" action="<?=base_url()?>index.php/testapi">
<table width="721" height="360" border="0" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    ...
    <td height="31" valign="top" bgcolor="#FFFFFF"><label>
      <input name="url" type="text" size="80" value="123123"/>
    </label></td>
  </tr>
  <tr>
    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><label>
      <textarea name="data" cols="80" rows="20"><?=$data?></textarea>
    </label></td>
  </tr>
  <tr>
