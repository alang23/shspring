...
class Doubt extends Admin_Controller
{
	...
	public function index()
	{
        ...
        $count = $this->doubt->get_count();
       
        $this->load->library('pagination');
        $config['base_url'] = base_url('index.php/home/feedback/doubt?');
        ...
        $list = $this->doubt->getList($wherelist);
        $data['list'] = $list;
    ...
    public function add()
    {
        if(!empty($_POST)){
            ...
            $this->load->view('home/doubt/home_doubt_add');
        }
    }
